...
攻击方对照跑不了 —— **Gemini 免费层是每天 20 次**,一轮校准需要约 3,400 次
(见 Step 18)。这个决定必须由作者做:要么花钱,要么改选型原则。
以下原始记录保留供追溯。
...
### 2026-08-02 · Step 18 · ⛔ Gemini 免费层是**每天 20 次**,attacker 侧选型作废
...
- **剩余状态:** ⛔ **BLOCKED,需要作者决定 attacker 侧怎么办。**
  这不是可以自己拍板的事 —— 它要么花钱,要么改动 Step 01 里那条
  "跑量小但决定成败的一侧不省"的选型原则。
